...
(function (e, t) {
    ...
    function nn(e) {
        ...
        if (n === "none" || n === "") {
            Pt = i
                .body
                .appendChild(Pt || v.extend(i.createElement("iframe"), {
                    frameBorder: 0,
                    width: 0,
                    height: 0
                }));
            ...
            t = Ht
                .body
                .appendChild(Ht.createElement(e)),
            n = Dt(t, "display"),
            i
                .body
                .removeChild(Pt)
    ...
    function Gn(e, t, n) {
        ...
        ], v.css(e, "display") === "inline" && v.css(e, "float") === "none" && (!v.support.inlineBlockNeedsLayout || nn(e.nodeName) === "inline"
        ...
        if (o) {
            ...
            for (r = 0; r < o; r++) 
                ...
                f = h.createTween(i, g
                    ...
                    : 0),
                d[i] = u[i] || v.style(e, i),
                i in u || (u[i] = f.start, g && (f.end = f.start, f.start = i === "width" || i === "height"
                    ? 1
                    : 0))
            }
    }
    ...
    v.extend({
        ...
        makeArray: function (e, t) {
            var n,
                r = t || [];
            return e != null && (n = v.type(e), e.length == null || n === "string" || n === "function" || n === "regexp" || v.isWindow(e)
                ? f.call(r, e)
                : v.merge(r, e)),
            r
        },
        ...
        proxy: function (e, n) {
            ...
            v.isFunction(e)
                ? (i = l.call(arguments, 2), s = function () {
    ...
    v.extend({
        Deferred: function (e) {
            var t = [
                    [
                        "resolve", "done", v.Callbacks("once memory"),
                        "resolved"
                    ],
                    [
                        "reject", "fail", v.Callbacks("once memory"),
                        "rejected"
                    ],
                    [
        ...
        when: function (e) {
            var t = 0,
                n = l.call(arguments),
                r = n.length,
                i = r !== 1 || e && v.isFunction(e.promise)
                    ? r
                    : 0,
                s = i === 1
                    ? e
    ...
    return v(function () {
            ...
            r.innerHTML = "",
            r.style.cssText = "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;p" +
    ...
    v.extend({
        ...
        data: function (e, n, r, i) {
            ...
            if ((!c || !l[c] || !i && !l[c].data) && a && r === t) 
                return;
            c || (f
                ? e[u] = c = v.deletedIds.pop() || v.guid ++: c = u),
    ...
    v
        ...
        .extend({
            ...
            val: function (e) {
                ...
                if (!arguments.length) {
                    if (s) 
                        return n = v.valHooks[s.type] || v.valHooks[
                            s
                                .nodeName
                                .toLowerCase()
                        ],
                ...
                this.each(function (r) {
                    ...
                    s == null
                        ...
                        : typeof s == "number"
                            ? s += ""
                            : v.isArray(s) && (s = v.map(s, function (e) {
                                return e == null
                                    ? ""
                                    : e + ""
                            })),
                    n = v.valHooks[this.type] || v.valHooks[
                        this
                            .nodeName
                            .toLowerCase()
                    ];
    ...
    v.extend({
        valHooks: {
            ...
            select: {
                get: function (e) {
                    ...
                    for (; a < u; a++) {
                        n = r[a];
                        if ((n.selected || a === i) && (v.support.optDisabled
                            ? !n.disabled
                            : n.getAttribute("disabled") === null) && (!n.parentNode.disabled || !v.nodeName(n.parentNode, "optgroup"))) {
                            t = v(n).val();
                            if (s) 
                                return t;
                            o.push(t)
        ...
        attr: function (e, n, r, i) {
            ...
            if (typeof e.getAttribute == "undefined") 
                return v.prop(e, n, r);
            u = a !== 1 || !v.isXMLDoc(e),
            u && (n = n.toLowerCase(), o = v.attrHooks[n] || (X.test(n)
                ? F
                : j));
            if (r !== t) {
                if (r === null) {
        ...
        removeAttr: function (e, t) {
            ...
            if (t && e.nodeType === 1) {
                ...
                for (; o < r.length; o++) 
                    i = r[o],
                    i && (n = v.propFix[i] || i, s = X.test(i), s || v.attr(e, i, ""), e.removeAttribute(V
                        ? i
                        : n), s && n in e && (e[n] = !1))
                }
        },
    ...
    v.event = {
        ...
        dispatch: function (n) {
            ...
            return b.postDispatch && b
                .postDispatch
                .call(this, n),
            n.result
        },
        props: ("attrChange attrName relatedNode srcElement altKey bubbles cancelable ctrlKey cu" +
                "rrentTarget eventPhase metaKey relatedTarget shiftKey target timeStamp view whic" +
                "h").split(" "),
        fixHooks: {},
        keyHooks: {
            props: "char charCode key keyCode".split(" "),
            filter: function (e, t) {
                return e.which == null && (e.which = t.charCode != null
                    ? t.charCode
                    : t.keyCode),
                e
            }
        ...
        mouseHooks: {
            ...
            filter: function (e, n) {
                ...
                !e.relatedTarget && a && (e.relatedTarget = a === e.target
                    ? n.toElement
                    : a),
                !e.which && u !== t && (e.which = u & 1
                    ? 1
                    : u & 2
                        ? 3
                        : u & 4
        ...
        setup: function () {
            ...
            v
                ...
                .add(this, "click._submit keypress._submit", function (e) {
                    var n = e.target,
                        r = v.nodeName(n, "input") || v.nodeName(n, "button")
                            ? n.form
                            : t;
            ...
            v
                ...
                .add(this, "beforeactivate._change", function (e) {
                    ...
                    $.test(t.nodeName) && !v._data(t, "_change_attached") && (v.event.add(t, "change._change", function (e) {
                        this.parentNode && !e.isSimulated && !e.isTrigger && v
                            .event
    ...
    v.support.focusinBubbles || v.each({
        ...
        var n = 0,
            r = function (e) {
                v
                    .event
                    .simulate(t, e.target, v.event.fix(e), !0)
            };
        v.event.special[t] = {
            setup: function () {
        ...
        .extend({
            ...
            off: function (e, n, r) {
                ...
                if (e && e.preventDefault && e.handleObj) 
                    ...
                    v(e.delegateTarget).off(i.namespace
    ...
    v.each(("blur focus focusin focusout load resize scroll unload click dblclick mousedown " +
    ...
    function (e, t) {
        ...
        var n,
            ...
            G = K(function (e) {
                ...
                e.firstChild && typeof e.firstChild.getAttribute !== p && e
                    .firstChild
                    .getAttribute("href") === "#"
            }),
            Y = K(function (e) {
        ...
        i = nt.selectors = {
                ...
                ID: r
                    ...
                    : function (e, n, r) {
                        if (typeof n.getElementById !== p && !r) {
                            ...
                            return i
                                ? i.id === e || typeof i.getAttributeNode !== p && i
                                    .getAttributeNode("id")
                                    .value === e
                                    ? [i]
                                    : t
            ...
            preFilter: {
                ...
                CHILD: function (e) {
                    ...
                    e[1] === "nth"
                        ? (e[2] || nt.error(e[0]), e[3] =+ (e[3]
                            ? e[4] + (e[5] || 1)
                            : 2 * (e[2] === "even" || e[2] === "odd")), e[4] =+ (e[6] + e[7] || e[2] === "odd"))
                        : e[2] && nt.error(e[0]),
                    e
                },
                PSEUDO: function (e) {
            ...
            pseudos: {
                ...
                text: function (e) {
                    ...
                    return e
                        .nodeName
                        .toLowerCase() === "input" && (t = e.type) === "text" && ((n = e.getAttribute("type")) == null || n.toLowerCase() === t)
                },
                radio: rt("radio"),
        ...
        g.querySelectorAll && function () {
            ...
            K(function (e) {
                ...
                e
                    ...
                    .length || i.push("\\[" + O + "*(?:checked|disabled|ismap|multiple|readonly|selected|value)"),
                e
        ...
        .extend({
            ...
            add: function (e, t) {
                var n = typeof e == "string"
                        ? v(e, t)
                        : v.makeArray(e && e.nodeType
                            ? [e]
                            : e),
                    r = v.merge(this.get(), n);
                return this.pushStack(ut(n[0]) || ut(r[0])
                    ? r
                    : v.unique(r))
            },
            addBack: function (e) {
    ...
    var ct = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|foot" +
    ...
    v
        ...
        .extend({
            text: function (e) {
                return v.access(this, function (e) {
                    return e === t
                        ...
                        : this
                            .empty()
                            .append((this[0] && this[0].ownerDocument || i).createTextNode(e))
            ...
            replaceWith: function (e) {
                return ut(this[0])
                    ? this.length
                        ? this.pushStack(v(v.isFunction(e)
                            ? e()
                            : e), "replaceWith", e)
                        : this
                    : v.isFunction(e)
                ...
                if (this[0]) {
                    ...
                    if (s) {
                        ...
                        for (u = i.cacheable || c - 1; a < c; a++) 
                            r.call(n && v.nodeName(this[a], "table")
                                ? Lt(this[a], "tbody")
                                : this[a], a === u
                                ? o
                                : v.clone(o, !0, !0))
    ...
    v.extend({
        ...
        css: function (e, n, r, i) {
            ...
            r || i !== t
                ? (o = parseFloat(s), r || v.isNumeric(o)
                    ? o || 0
                    : s)
                : s
        },
    ...
    e.getComputedStyle
        ...
        : i.documentElement.currentStyle && (Dt = function (e, t) {
            ...
            Ut.test(i) && !Ft.test(t) && (n = s.left, r = e.runtimeStyle && e.runtimeStyle.left, r && (e.runtimeStyle.left = e.currentStyle.left), s.left = t === "fontSize"
                ? "1em"
                : i, i = s.pixelLeft + "px", s.left = n, r && (e.runtimeStyle.left = r)),
            i === ""
                ? "auto"
                : i
        }),
    v.each([
        ...
        v.cssHooks[t] = {
            ...
            set: function (e, n, r) {
                return Zt(e, n, r
                    ? en(e, t, r, v.support.boxSizing && v.css(e, "boxSizing") === "border-box")
                    : 0)
            }
        }
    }),
    v.support.opacity || (v.cssHooks.opacity = {
        get: function (e, t) {
            return jt.test((t && e.currentStyle
    ...
    v.fn.load = function (e, n, r) {
        ...
        v.ajax({
            ...
            .done(function (e) {
                o = arguments,
                u.html(i
                    ? v("<div>").append(e.replace(yn, "")).find(i)
                    : e)
            }),
        this
    },
    ...
    v.extend({
        ...
        ajax: function (e, n) {
            ...
            var r,
                ...
                c = v.ajaxSetup({}, n),
                h = c.context || c,
                p = h !== c && (h.nodeType || h instanceof v)
                    ? v(h)
                    : v.event,
                d = v.Deferred(),
            ...
            c.dataTypes = v
                ...
                .toLowerCase()
                .split(y),
            c.crossDomain == null && (a = wn.exec(c.url.toLowerCase()), c.crossDomain = !(!a || a[1] === ln[1] && a[2] === ln[2] && (a[3] || (a[1] === "http:"
                ? 80
                : 443)) == (ln[3] || (ln[1] === "http:"
                ? 80
                : 443)))),
            ...
            x.setRequestHeader("Accept", c.dataTypes[0] && c.accepts[c.dataTypes[0]]
    ...
    v.ajaxPrefilter("json jsonp", function (n, r, i) {
        ...
        if (n.dataTypes[0] === "jsonp" || c || h) 
            return s = n.jsonpCallback = v.isFunction(n.jsonpCallback)
                ? n.jsonpCallback()
                : n.jsonpCallback,
            o = e[s],
            c
        ...
        _default: {
            get: function (e) {
                ...
                return e.elem[e.prop] == null || !!e.elem.style && e.elem.style[e.prop] != null
                    ? (t = v.css(e.elem, e.prop, !1, ""), !t || t === "auto"
                        ? 0
                        : t)
                    : e.elem[e.prop]
            },
    ...
    v.fx.timer = function (e) {
        e() && v
            .timers
            .push(e) && !Rn && (Rn = setInterval(v.fx.tick, v.fx.interval))
    },
    v.fx.interval = 13,
    v.fx.stop = function () {
        clearInterval(Rn),
    ...
    v.fn.offset = function (e) {
        ...
        return (r = c.body) === l
            ...
            : (n = c.documentElement, v.contains(n, l)
                ? (typeof l.getBoundingClientRect != "undefined" && (f = l.getBoundingClientRect()), i = tr(c), s = n.clientTop || r.clientTop || 0, o = n.clientLeft || r.clientLeft || 0, u = i.pageYOffset || n.scrollTop, a = i.pageXOffset || n.scrollLeft, {
                    top: f.top + u - s,
                    left: f.left + a - o
                })
                : f)

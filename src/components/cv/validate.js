...
(function (c) {
    c.extend(c.fn, {
        ...
        rules: function (a, b) {
            ...
            d = c
                .validator
                .normalizeRules(c.extend({}, c.validator.metadataRules(d), c.validator.classRules(d), c.validator.attributeRules(d), c.validator.staticRules(d)), d);
            if (d.required) {
                e = d.required;
                delete d.required;
                d = c.extend({
    ...
    c.extend(c.validator, {
        defaults: {
            ...
            onfocusin: function (a) {
                ...
                if (this.settings.focusCleanup && !this.blockFocusCleanup) {
                    this.settings.unhighlight && this
                        .settings
                        .unhighlight
                        .call(this, a, this.settings.errorClass, this.settings.validClass);
                    this
                        .addWrapper(this.errorsFor(a))
                        .hide()
                }
            },
        ...
        prototype: {
            init: function () {
                ...
                c(this.currentForm)
                    .validateDelegate("[type='text'], [type='password'], [type='file'], select, textarea, [type='number" +
                        "'], [type='search'] ,[type='tel'], [type='url'], [type='email'], [type='datetime" +
                        "'], [type='date'], [type='month'], [type='week'], [type='time'], [type='datetime" +
                        "-local'], [type='range'], [type='color'] ",
                "focusin focusout keyup", a)
                    .validateDelegate("[type='radio'], [type='checkbox'], select, option", "click", a);
                ...
                for (e in b) {
                    ...
                    try {
                        var g = c
                            .validator
                            .methods[e]
                            .call(this, a.value.replace(/\r/g, ""), a, f.parameters);
            ...
            defaultShowErrors: function () {
                for (var a = 0; this.errorList[a]; a++) {
                    ...
                    this.settings.highlight && this
                        .settings
                        .highlight
                        .call(this, b.element, this.settings.errorClass, this.settings.validClass);
            ...
            showLabel: function (a, b) {
                ...
                if (d.length) {
                    ...
                    this
                        .labelContainer
                        .append(d)
                        .length || (this.settings.errorPlacement
            ...
            optional: function (a) {
                return !c
                    ...
                    .methods
                    .required
                    .call(this, c.trim(a.value), a) && "dependency-mismatch"
            },
        ...
        addMethod: function (a, b, d) {
            ...
            b.length < 3 && c
                .validator
                .addClassRules(a, c.validator.normalizeRule(a))
        },
        methods: {

            ...
            <div className="demo-big-content">
                <Layout>
                    <Header className="header-color" title="Portofolio" style={{color:"#00ff00"}} scroll> 
                        <Navigation >
                            <Badge color ="info"><Link style={{ fontStyle:"Bold", fontSize:"15px"}} to="/Home" >Home</Link></Badge>
                            <Badge color ="info"><Link style={{ fontStyle:"Bold", fontSize:"15px"}} to="/AboutMe">About Me</Link></Badge>
                            <Badge color ="info"><Link style={{ fontStyle:"Bold", fontSize:"15px"}} to="/Game">Game</Link></Badge>
                            <Badge color ="info"><Link style={{ fontStyle:"Bold", fontSize:"15px"}} to="/Website">Website</Link></Badge>
                            <Badge color ="info"><Link style={{ fontStyle:"Bold", fontSize:"15px"}} to="/Apps">Android</Link></Badge>
                        </Navigation>
                    </Header>
